...
local blizzardAddons = {
	-- ["Blizzard_AccountSaveDebug"] = true,
	-- ["Blizzard_AccountSaveUI"] = true,
	-- ["Blizzard_AchievementUI"] = true,
	-- ["Blizzard_AdventureMap"] = true,
	-- ["Blizzard_AlliedRacesUI"] = true,
	-- ["Blizzard_AnimaDiversionUI"] = true,
	-- ["Blizzard_AnimCreate"] = true,
	-- ["Blizzard_APIDocumentation"] = true,
	-- ["Blizzard_APIDocumentationGenerated"] = true,
	-- ["Blizzard_ArchaeologyUI"] = true,
	-- ["Blizzard_ArdenwealdGardening"] = true,
	-- ["Blizzard_ArtifactUI"] = true,
	-- ["Blizzard_AuctionHouseShared"] = true,
	-- ["Blizzard_AuctionHouseUI"] = true,
	-- ["Blizzard_AuthChallengeUI"] = true,
	-- ["Blizzard_AutoXML"] = true,
	-- ["Blizzard_AzeriteEssenceUI"] = true,
	-- ["Blizzard_AzeriteRespecUI"] = true,
	-- ["Blizzard_AzeriteUI"] = true,
	-- ["Blizzard_BarbershopUI"] = true,
	-- ["Blizzard_BattlefieldMap"] = true,
	-- ["Blizzard_BehavioralMessaging"] = true,
	-- ["Blizzard_BlackMarketUI"] = true,
	-- ["Blizzard_BoostTutorial"] = true,
	-- ["Blizzard_CachedLogin"] = true,
	-- ["Blizzard_Calendar"] = true,
	-- ["Blizzard_ChallengesUI"] = true,
	-- ["Blizzard_Channels"] = true,
	-- ["Blizzard_CharacterCreate"] = true,
	-- ["Blizzard_CharacterCustomize"] = true,
	-- ["Blizzard_ChromieTimeUI"] = true,
	-- ["Blizzard_ClassTalentDebug"] = true,
	-- ["Blizzard_ClassTalentUI"] = true,
	-- ["Blizzard_ClassTrial"] = true,
	-- ["Blizzard_ClickBindingUI"] = true,
	-- ["Blizzard_ClientSavedVariables"] = true,
	-- ["Blizzard_Collections"] = true,
	-- ["Blizzard_CombatLog"] = true,
	-- ["Blizzard_CombatText"] = true,
	-- ["Blizzard_Commentator"] = true,
	-- ["Blizzard_Communities"] = true,
	-- ["Blizzard_CompactRaidFrames"] = true,
	-- ["Blizzard_Console"] = true,
	-- ["Blizzard_ConsoleExtensions"] = true,
	-- ["Blizzard_ConsoleScriptCollection"] = true,
	-- ["Blizzard_Contribution"] = true,
	-- ["Blizzard_CovenantCallings"] = true,
	-- ["Blizzard_CovenantPreviewUI"] = true,
	-- ["Blizzard_CovenantRenown"] = true,
	-- ["Blizzard_CovenantSanctum"] = true,
	-- ["Blizzard_CovenantToasts"] = true,
	-- ["Blizzard_CUFProfiles"] = true,
	-- ["Blizzard_DeathRecap"] = true,
	-- ["Blizzard_DebugLoader"] = true,
	-- ["Blizzard_DebugTools"] = true,
	-- ["Blizzard_Deprecated"] = true,
	-- ["Blizzard_EncounterJournal"] = true,
	-- ["Blizzard_EventTrace"] = true,
	-- ["Blizzard_ExpansionLandingPage"] = true,
	-- ["Blizzard_ExpansionTrial"] = true,
	-- ["Blizzard_FlightMap"] = true,
	-- ["Blizzard_FrameEffects"] = true,
	-- ["Blizzard_GarrisonTemplates"] = true,
	-- ["Blizzard_GarrisonUI"] = true,
	-- ["Blizzard_GenericTraitUI"] = true,
	-- ["Blizzard_GMChatUI"] = true,
	-- ["Blizzard_GuildBankUI"] = true,
	-- ["Blizzard_GuildControlUI"] = true,
	-- ["Blizzard_HybridMinimap"] = true,
	-- ["Blizzard_InspectUI"] = true,
	-- ["Blizzard_IslandsPartyPoseUI"] = true,
	-- ["Blizzard_IslandsQueueUI"] = true,
	-- ["Blizzard_ItemInteractionUI"] = true,
	-- ["Blizzard_ItemSocketingUI"] = true,
	-- ["Blizzard_ItemUpgradeDebug"] = true,
	-- ["Blizzard_ItemUpgradeUI"] = true,
	-- ["Blizzard_Kiosk"] = true,
	-- ["Blizzard_LandingSoulbinds"] = true,
	-- ["Blizzard_LoginErrorHelpers"] = true,
	-- ["Blizzard_MacroUI"] = true,
	-- ["Blizzard_MajorFactions"] = true,
	-- ["Blizzard_MapCanvas"] = true,
	-- ["Blizzard_MawBuffs"] = true,
	-- ["Blizzard_MoneyReceipt"] = true,
	-- ["Blizzard_MovePad"] = true,
	-- ["Blizzard_NamePlates"] = true,
	-- ["Blizzard_NewPlayerExperience"] = true,
	-- ["Blizzard_NewPlayerExperienceGuide"] = true,
	-- ["Blizzard_ObjectiveTracker"] = true,
	-- ["Blizzard_ObliterumUI"] = true,
	-- ["Blizzard_OrderHallUI"] = true,
	-- ["Blizzard_PartyPoseUI"] = true,
	-- ["Blizzard_PerksActivitiesDebug"] = true,
	-- ["Blizzard_PerksProgram"] = true,
	-- ["Blizzard_PerksProgramDevTool"] = true,
	-- ["Blizzard_PetBattleUI"] = true,
	-- ["Blizzard_PlayerChoice"] = true,
	-- ["Blizzard_PrivateAurasUI"] = true,
	-- ["Blizzard_Professions"] = true,
	-- ["Blizzard_ProfessionsCustomerOrders"] = true,
	-- ["Blizzard_ProfessionsDebug"] = true,
	-- ["Blizzard_ProfessionsTemplates"] = true,
	-- ["Blizzard_ProfSpecsImporter"] = true,
	-- ["Blizzard_PrototypeDialog"] = true,
	-- ["Blizzard_PTRFeedback"] = true,
	-- ["Blizzard_PTRFeedbackGlue"] = true,
	-- ["Blizzard_PVPMatch"] = true,
	-- ["Blizzard_PVPUI"] = true,
	-- ["Blizzard_QuestNavigation"] = true,
	-- ["Blizzard_QuestNextQuestLog"] = true,
	-- ["Blizzard_RaidUI"] = true,
	-- ["Blizzard_RuneforgeUI"] = true,
	-- ["Blizzard_ScrappingMachineUI"] = true,
	-- ["Blizzard_ScriptedAnimationsTest"] = true,
	-- ["Blizzard_ScrollBoxDebug"] = true,
	-- ["Blizzard_SecureTransferUI"] = true,
	-- ["Blizzard_SelectorUI"] = true,
	-- ["Blizzard_Settings"] = true,
	-- ["Blizzard_SettingsDebug"] = true,
	-- ["Blizzard_SharedMapDataProviders"] = true,
	-- ["Blizzard_SharedTalentUI"] = true,
	-- ["Blizzard_SharedWidgetFrames"] = true,
	-- ["Blizzard_Soulbinds"] = true,
	-- ["Blizzard_SoulbindsDebug"] = true,
	-- ["Blizzard_StoreUI"] = true,
	-- ["Blizzard_SubscriptionInterstitialUI"] = true,
	-- ["Blizzard_TalentTestAPI"] = true,
	-- ["Blizzard_TalentTestData"] = true,
	-- ["Blizzard_TalentTestUI"] = true,
	-- ["Blizzard_TalentUI"] = true,
	-- ["Blizzard_TestDataset"] = true,
	-- ["Blizzard_TestDatasetEditor"] = true,
	-- ["Blizzard_TestFrame"] = true,
	-- ["Blizzard_TestingMode"] = true,
	-- ["Blizzard_TimeEvents"] = true,
	-- ["Blizzard_TimeManager"] = true,
	-- ["Blizzard_TokenUI"] = true,
	-- ["Blizzard_ToolsUI"] = true,
	-- ["Blizzard_TorghastLevelPicker"] = true,
	-- ["Blizzard_TrainerUI"] = true,
	-- ["Blizzard_TutorialManager"] = true,
	-- ["Blizzard_Tutorials"] = true,
	-- ["Blizzard_UIFrameManager"] = true,
	-- ["Blizzard_UIModelSceneEditor"] = true,
	-- ["Blizzard_UIWidgets"] = true,
	-- ["Blizzard_UndoSystem"] = true,
	-- ["Blizzard_Utility"] = true,
	-- ["Blizzard_VexData"] = true,
	-- ["Blizzard_VexToolUI"] = true,
	-- ["Blizzard_VexViewerUI"] = true,
...
local function saveAddonData(id, skipCheck)
	...
	local author = C_AddOns.GetAddOnMetadata(id, "Author")
	if author then
		author = strtrim(author)
	end

	-- Strip out common version strings that are used sometimes
	local version = C_AddOns.GetAddOnMetadata(id, "Version") or C_AddOns.GetAddOnMetadata(id, "X-Curse-Packaged-Version")
	if version then
